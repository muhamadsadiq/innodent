...
const catalogClosingText =
  "For a complete overview of our latest dental instruments and technical data, please access our comprehensive product guide. Our digital catalog includes detailed dimensions, material specifications, and maintenance protocols for all Innodent systems.";

const catalogPdfMap: Record<string, string> = {
  "Catalog 1": "/brochures/catalog-1.pdf",
  "Catalog 2": "/brochures/catalog-2.pdf",
  "Catalog 3": "/brochures/catalog-3.pdf",
};
      ...
      <div className="min-w-0 flex-1 pt-[22px]">
        <div className="flex flex-wrap items-center justify-between gap-2 mr-[35px]">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span
              className="rounded-full border border-[var(--border-color)] px-[18px] text-[18px] leading-[54.802px] text-[var(--text-color)]"
              style={{
                ["--text-color" as string]: palette.chipTextColor,
                ["--border-color" as string]: palette.chipBorderColor,
              }}>
        ...
        <p
          className="max-w-[368px] mt-[23px] text-[24px] leading-6 ml-[10px] text-[var(--color-gray)]">{p.shortDescription}</p>
        <p className="mt-[32px] text-[24px] leading-6 ml-[10px] text-[var(--color-charcoal)]">{p.description}</p>
      </div>
    </Link>)
  };
    ...
    <>
      <section className="mx-auto max-w-[1677.019px] pt-10 sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          {!isSmallScreen && (<div className="inline-flex items-center gap-2 p-1">
            <button
              type="button"
              ...
              return (
                <section key={`list-${catalogName}`} className="space-y-6">
                  ...
                  <div className="mx-auto max-w-4xl pt-4 text-center">
                    ...
                    <a
                      href={catalogPdfMap[catalogName] ?? "/brochures/product-catalog.pdf"}
